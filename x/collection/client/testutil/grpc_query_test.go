...
// 	recipient := sdk.AccAddress(crypto.AddressHash([]byte("test")))
// 	// ---------------------------------------------------------------------------
...
// 	url := fmt.Sprintf("%s/uptick/collection/nft/denoms/%s", baseURL, denomID)
...
// 	url = fmt.Sprintf("%s/uptick/collection/nft/denoms", baseURL)
// 	resp, err = rest.GetRequest(url)
...
// 	url = fmt.Sprintf("%s/uptick/collection/collections/%s/supply", baseURL, denomID)
// 	resp, err = rest.GetRequest(url)
...
// 	//------test GetCmdQueryNFT()-------------
// 	url = fmt.Sprintf("%s/uptick/collection/nfts/%s/%s", baseURL, denomID, tokenID)
// 	resp, err = rest.GetRequest(url)
...
// 	url = fmt.Sprintf("%s/uptick/collection/nfts?owner=%s", baseURL, from.String())
// 	resp, err = rest.GetRequest(url)
...
// 	url = fmt.Sprintf("%s/uptick/collection/collections/%s", baseURL, denomID)
// 	resp, err = rest.GetRequest(url)
