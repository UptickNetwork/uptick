...
func (*TokenPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_372d8d843a8a0881, []int{0}
}
...
func init() {
	proto.RegisterType((*TokenPair)(nil), "uptick.evm_ibc.v1.TokenPair")
}

func init() { proto.RegisterFile("uptick/evm_ibc/v1/evm_ibc.proto", fileDescriptor_372d8d843a8a0881) }

var fileDescriptor_372d8d843a8a0881 = []byte{
	// 215 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *TokenPair) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ClassId) > 0 {
		...
		i = encodeVarintEvmIbc(dAtA, i, uint64(len(m.ClassId)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Erc721Address) > 0 {
		...
		i = encodeVarintEvmIbc(dAtA, i, uint64(len(m.Erc721Address)))
		i--
		dAtA[i] = 0xa
	}
...
func encodeVarintEvmIbc(dAtA []byte, offset int, v uint64) int {
	offset -= sovEvmIbc(v)
	base := offset
	for v >= 1<<7 {
...
func sovEvmIbc(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozEvmIbc(x uint64) (n int) {
	return sovEvmIbc(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *TokenPair) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		default:
			iNdEx = preIndex
			skippy, err := skipEvmIbc(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipEvmIbc(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthEvmIbc
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupEvmIbc
			}
			depth--
		case 5:
			iNdEx += 4
