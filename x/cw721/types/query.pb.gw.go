...
var (
	pattern_Query_TokenPairs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"uptick", "cw721", "v1", "token_pairs"}, "", runtime.AssumeColonVerbOpt(false)))
