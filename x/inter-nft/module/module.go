...
import (
	...
	"github.com/UptickNetwork/uptick/x/inter-nft/client/cli"
	"github.com/UptickNetwork/uptick/x/inter-nft/keeper"
...
func (am AppModule) RegisterServices(cfg module.Configurator) {
	internft.RegisterMsgServer(cfg.MsgServer(), am.keeper)
...
func (am AppModule) Route() sdk.Route {
	return sdk.NewRoute(internft.RouterKey, nil)
}
