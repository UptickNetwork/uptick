...
// The helper methods setupRegisterERC20Pair and setupRegisterCoin are defined per-file.
// Some API calls may need verification against the current cosmos-sdk/ethermint versions.
...
func (suite *KeeperTestSuite) TestRegisterCoin() {
	...
	testCases := []struct {
		...
		},
		{
			...
			func() {
				regPair := types.NewTokenPair(common.HexToAddress("0x1234567890123456789012345678901234567890"), metadata.Base, true, types.OWNER_MODULE)
