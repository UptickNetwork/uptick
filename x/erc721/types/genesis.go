...
// the audit required: non-empty UIDs, one-to-one uniqueness across the whole
// batch, UID membership in a registered token pair, and refund receivers that
// reference registered token pairs.
