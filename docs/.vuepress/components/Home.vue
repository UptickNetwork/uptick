<template lang="pug">
  div
    ...
    .h2 Getting Started
    .p__alt Read all about Uptick or dive straight into the code with guides.
    .features
      ...
      router-link(to="/guides").features__item.features__item__dark
        ...
        .features__item__text
          ...
          .features__item__text__p Follow guides to using popular Ethereum tools with Uptick.
    .sections__wrapper
      .h2 Explore Uptick
      .p__alt Get familiar with Uptick and explore its main concepts.
      .sections
    ...
    .p__alt Check out the docs for the various parts of the Uptick stack.
    .stack
