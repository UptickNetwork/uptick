...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/UptickNetwork/uptick/tree/main/CONTRIBUTING.md#updating-documentation)
...
The documentation for Uptick is hosted at [uptick.dev](https://docs.uptick.network/)

built from the files in this (`/docs`) directory for
[master](https://github.com/UptickNetwork/uptick/tree/main/docs).
