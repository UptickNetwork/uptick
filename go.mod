...
require (
	github.com/bianjieai/nft-transfer v0.0.0-20221109033137-3805eb32c2d2
	...
	github.com/irisnet/irismod v1.7.0-rc1.0.20221114081932-53e6d7d0543a
...
require (
	...
	cloud.google.com/go/storage v1.27.0 // indirect; indirectx
