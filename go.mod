...
require (
	...
	github.com/ethereum/go-ethereum v1.17.0 // replaced by cosmos/go-ethereum
...
require (
	...
	cloud.google.com/go/storage v1.50.0 // indirect; indirectx
...
replace (
	...
	// ethermint v0.24.2-uptick adds GetStateAndCommittedState for cosmos/go-ethereum compat
